...
@interface IONPlayerSliderCell : NSSliderCell
@end

@implementation IONPlayerSliderCell
...
@interface IONPlayerSlider : NSSlider
@end

@implementation IONPlayerSlider
+ (Class)cellClass { return [IONPlayerSliderCell class]; }
@end


@implementation IONPlayerControlView
...
- (id)initWithFrame:(NSRect)frame
{
    if ((self = [super initWithFrame:frame])) {
        ...
        _timeSlider = [[IONPlayerSlider alloc] initWithFrame:NSMakeRect(0, 0, 235, 20)];
